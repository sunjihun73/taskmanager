...
<!-- 					<img src="img/avatars/icon_logout.png" class="avatar img-fluid rounded" alt="logout" /> -->
<!-- 					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-power align-middle me-2"><path d="M18.36 6.64a9 9 0 1 1-12.73 0"></path><line x1="12" y1="2" x2="12" y2="12"></line></svg> -->
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-power align-middle me-2"><path d="M18.36 6.64a9 9 0 1 1-12.73 0"></path><line x1="12" y1="2" x2="12" y2="12"></line></svg>
				</a>
...
<!-- 					<a class="dropdown-item" href="pages-settings.html"><i class="align-middle me-1" data-feather="settings"></i> Settings & Privacy</a> -->
					...
					<c:forEach var="item" items="${empAuthorities}" varStatus="status">
						<c:if test="${item.authorityName == 'ROLE_ADMIN'}">
							<a id="adminDiv" class="dropdown-item" href="/admin/emps/usermngform"><i class="align-middle me-1" data-feather="user"></i> 관리자 사이트</a>
						</c:if>
					</c:forEach>
					<a class="dropdown-item" href="/auth/sso/logout"><i class="align-middle me-1" data-feather="log-out"></i> Log out</a>
				</div>
			</li>
		</ul>
	</div>
