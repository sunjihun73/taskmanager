                            ...
                            <div class="tab" style="margin-bottom: 0 !important;">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab-3" role="tabpanel">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row" style="margin-bottom: 15px;">
                                                    <div class="col-12 col-xl-3">
                                                        <div class="row">
                                                            <label for="tab3TaskState" class="col-form-label col-sm-3 text-sm-end"><b>상태</b></label>
                                                            <div class="col-sm-8">
                                                                <select id="tab3TaskState" class="form-select">
                                                                    <option selected value="">전체</option>
                                                    ...
                                                    <div class="col-12 col-xl-3">
                                                        <div class="row">
                                                            <label for="tab3TaskEmpCd" class="col-form-label col-sm-3 text-sm-end"><b>권한</b></label>
                                                            <div class="col-sm-8">
                                                                <select id="tab3TaskEmpCd" class="form-select">
                                                                    <option selected value="">전체</option>
                                                    ...
                                                    <div class="col-12 col-xl-3">
                                                        <div class="row">
                                                            <label for="tab3TaskLevel" class="col-form-label col-sm-3 text-sm-end"><b>업무 Level</b></label>
                                                            <div class="col-sm-8">
                                                                <select id="tab3TaskLevel" class="form-select">
                                                                    <option selected value="">전체</option>
                                                    ...
                                                    <div class="col-12 col-xl-3">
                                                        <div class="row">
                                                            <div style="float:right;">
                                                                <button id="btnTab3Search" class="btn btn-primary mt-n1"><i class="fas fa-search"></i> 조회</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div id="projectFullcalendar"></div>
                                        </div>
                                        <%-- //////////////// 탭 3 내용 끝 /////////////// --%>
                                    </div>
...
let isInitCalendarTab = false;
let projectCalendar = null;
let gCalendarLabelId = "";
let taskGanttChart;
...
function fnSetEvent() {
    ...
    //////////////////////////캘린더 탭 이벤트 /////////////////////////////
    $('a[data-bs-toggle="tab"][href="#tab-3"]').on('shown.bs.tab', function () {
        if (!isInitCalendarTab) {
            fnInitProjectCalendarTab();
            isInitCalendarTab = true;
        }

        if (projectCalendar) {
            setTimeout(function() {
                projectCalendar.updateSize();
            }, 200);
            fnReloadProjectCalendar();
        }
    });

    $("#btnTab3Search").off("click").on("click", function (e) {
        e.preventDefault();
        fnReloadProjectCalendar();
    });
    //////////////////////////캘린더 탭 이벤트 끝/////////////////////////////
...
//*****************************캘린더 탭 처리 ******************************* //
function fnInitProjectCalendarTab() {
    fnInitProjectCalendar();
}

function fnInitProjectCalendar() {
    let today = new Date();
    ...
    let calendarEl = document.getElementById("projectFullcalendar");
    if (!calendarEl) {
        return;
    }
    ...
    projectCalendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventSources: [{
            events: function(info, successCallback, failureCallback) {
                let params = new Object();
                params.taskState = $("#tab3TaskState").val();
                params.childTaskAddYn = $("#tab3TaskLevel").val();
                params.taskEmpCd = $("#tab3TaskEmpCd").val();
                params.labelId = gCalendarLabelId;
                ...
                $.ajax({
                    ...
                    $.each(data, function(idx, item){
                        ...
                        let endDate = parseInt(gfnNoFormatDate(item.end)) + 1;
                        events.push({
...
function fnReloadProjectCalendar() {
    if (projectCalendar) {
