...
let gCmmnProjectNm = "프로젝트";
let gCmmnProjectEmpNm = "프로젝트참여자";
let gCmmnTaskNm = "태스크";
let gCmmnFileNm = "파일";
let gCmmnLabelNm = "라벨";
let gCmmnRptTask = "일일업무보고 태스크";
let gCmmnRptTaskRcv = "일일업무보고 수신 태스크";
let gCmmnRptTaskSnd = "일일업무보고 발신 태스크";
let gCmmnRptTaskTmp = "일일업무보고 임시저장 태스크";
let gCmmnSM_One = " 이(가) 조회되었습니다."; 
let gCmmnSM_List = " 목록이 조회되었습니다.";
let gCmmnSM_Update = " 이(가) 저장 되었습니다.";
let gCmmnSM_TmpUpdate = " 이(가) 임시 저장 되었습니다.";
let gCmmnSM_Delete = " 이(가) 삭제 되었습니다.";
let gCmmnSM_Insert = " 이(가) 등록 되었습니다.";
let gCmmnSM_Send = " 이(가) 보고 되었습니다.";
let gCmmnSM_Confirm = " 이(가) 확인 되었습니다.";
let gCmmnSM_FileUp = "파일이 업로드 되었습니다.";
let gCmmnSM_NOT_EXIT_TASK = "존재하지 않는 태스크입니다.";
let gCmmnSM_UNAUTHORIZED_ACCESS = "해당 태스크에 접근 권한이 존재하지 않습니다.";
