                                    ...
                                    <div class="tab-pane" id="tab-3" role="tabpanel">
                                        ...
                                        <div class="row" style="margin-bottom: 10px;">
                                            <div class="col-12 col-xl-3">
                                                <div class="row">
                                                    <label for="calTaskState" class="col-form-label col-sm-3 text-sm-end"><b>상태</b></label>
                                                    <div class="col-sm-8">
                                                        <select id="calTaskState" class="form-select">
                                                            <option selected value="">전체</option>
                                            ...
                                            <div class="col-12 col-xl-3">
                                                <div class="row">
                                                    <label for="calTaskEmpCd" class="col-form-label col-sm-3 text-sm-end"><b>권한</b></label>
                                                    <div class="col-sm-8">
                                                        <select id="calTaskEmpCd" class="form-select">
                                                            <option selected value="">전체</option>
                                            ...
                                            <div class="col-12 col-xl-3">
                                                <div class="row">
                                                    <label for="calTaskLevel" class="col-form-label col-sm-3 text-sm-end"><b>업무 Level</b></label>
                                                    <div class="col-sm-8">
                                                        <select id="calTaskLevel" class="form-select">
                                                            <option selected value="">전체</option>
                                            ...
                                            <div class="col-12 col-xl-3">
                                                <div class="row">
                                                    <div class="col-sm-12 text-end">
                                                        <button id="btnCalSearch" class="btn btn-primary"><i class="fas fa-search"></i> 조회</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
function fnSetEvent() {
    ...
    $('a[data-bs-toggle="tab"][href="#tab-3"]').on('shown.bs.tab', function () {
        fnSetProjectCalendar();
    });

    $("#btnCalSearch").off("click").on("click", function (e) {
        e.preventDefault();
        fnSetProjectCalendar();
    });
    //////////////////////////캘린더 탭 이벤트 끝/////////////////////////////
...
function fnSetProjectCalendar() {
	...
	let params = new Object();
	params.taskState = $("#calTaskState").val();
	params.childTaskAddYn = $("#calTaskLevel").val();
	params.taskEmpCd = $("#calTaskEmpCd").val();
	params.projectId = $("#pProjectId").val();

	var calendarEl = document.getElementById("projectFullcalendar");
