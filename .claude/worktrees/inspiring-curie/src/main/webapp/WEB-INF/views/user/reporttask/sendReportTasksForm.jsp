		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle"><b><i class="fas fa-list"></i> 일일업무보고 보고 목록</b></h1>
					</div>
									...
									<div class="row">
										...
										<div class="col-12 col-xl-3">
											<div class="row">
												...
												<div class="col-sm-8">
													<select id="taskStateCd" class="form-select">
														<option selected value="">전체</option>
														<option value="CM005CD002">보고</option>
						...
						<div class="col-md-12">
							<div class="card" >
								<div class="card-header">
									<h5 class="card-title" style="font-size:17px;"><i class="fas fa-fw fa-folder"></i> 일일업무보고 보고 목록</h5>
								</div>
								<div class="card-body">
...
// 일일 업무보고 발신 목록 그리드 재조회
function fnReselGrid() {
	dtReportTask.ajax.reload(function (json) {
		if (json.resultCode === "SUCCESS") {
			gfnSuccessAlert(gCmmnRptTaskSnd + gCmmnSM_List, 2000);
		}
		else {
...
// 일일 업무보고 발신 목록 그리드 초기화 
function fnSetGrid() {
	dtReportTask = $("#taskTable").DataTable({
		ajax: {
			url : "/rest/user/reporttasks/send/me",
            type : "POST",
			dataSrc : "data",
			data : function (d) {
...
function fnGoReportTaskDetail(taskId) {
	...
	let apiUrl = '/user/reporttasks/reporttaskviewform';
