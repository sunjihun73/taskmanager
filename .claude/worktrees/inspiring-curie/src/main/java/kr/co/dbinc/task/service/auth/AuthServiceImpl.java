...
public class AuthServiceImpl implements AuthService
{
  ...
  public ResultVO ssoLogin(String epToken, String userId) throws Exception
  {
    ...
    joTokenRsltData = this.getEpTokenData(epTokenUrl.toString());
  ...
  private JSONObject getEpTokenData (String epTokenUrl)
  {
    ...
    {
      // 예외 발생 시 적절하게 처리한다.
      log.debug("API 호출 중 오류가 발생했습니다: " + e.getMessage());
      return null;
    }
  }
